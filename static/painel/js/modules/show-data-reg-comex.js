        ...
        function (data) {
            if (data == 'NOT FOUND') {
                ...
                $.each(record, function (key, value) {
                    if (i == 0) {
                        var dt_registro = value[28].substring(0, 10);
                        var dt_envio = value[29].substring(0, 10);
                        var dt_vencto = value[30].substring(0, 10);
                        ...
                        document.getElementsByName('observacao')[0].value = value[7];
                        ...
                        document.getElementsByName('pref_1')[0].value = value[14];
                        document.getElementsByName('pref_2')[0].value = value[15];

                        document.getElementsByName('pref_3')[0].value = value[16];
                        document.getElementsByName('pref_4')[0].value = value[17];
                        document.getElementsByName('cnpj')[0].value = value[18];
                        document.getElementsByName('razao_social')[0].value = value[19];
                        document.getElementsByName('cod_parceiro')[0].value = value[24];

                        document.getElementsByName('analista')[0].value = value[25];
                        document.getElementsByName('conta')[0].value = value[26];

                        document.getElementsByName('tipo_conta')[0].value = value[27];
                        ...
                        document.getElementsByName('reg_total')[0].value = value[1];

                        document.getElementsByName('status_registro')[0].value = value[1];
